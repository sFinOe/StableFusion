    ...
    <Container className={styles.root}>
      <Grid.Container className={styles.Gird_Contaier}>
        <Grid.Container style={{ justifyContent: "space-between", marginBottom: "20px", alignItems: "center" }}>
          <Grid>
            <Text h2 style={{ fontFamily: "Ubuntu", fontSize: "30px", fontWeight: "500" }}>
              My Creations
            </Text>
          </Grid>
          {!GetAll && (
            <Grid style={{ justifyContent: "space-between", flexDirection: "row", display: "flex" }}>
              <Popover>
                <Popover.Trigger>
                  <Button ghost rounded color="success" auto style={{ fontFamily: "Ubuntu", fontSize: "20px", zIndex: "0", marginRight: "15px" }}>
                    Make more
                  </Button>
                </Popover.Trigger>
                <Popover.Content>
                  ...
                  >
                    <Input
                      aria-labelledby="makemore"
                      value={ImagesToMake}
                      onChange={handleMakeMoreImages}
                      color="primary"
                      animated={false}
                      bordered
                      placeholder="Make more images"
                    />
                    {!isMakeMore ? (
                      <Button flat color="primary" auto onPress={GenerateMoreImages} style={{ fontFamily: "Ubuntu", fontSize: "20px", zIndex: "0" }}>
                        make
                      </Button>
                    ) : (
              ...
              <Button ghost rounded color="success" auto style={{ fontFamily: "Ubuntu", fontSize: "20px", zIndex: "0" }} onPress={openCreateHandler}>
                Create
              </Button>
            </Grid>
          )}
        ...
        <Modal closeButton width="48%" open={CreateVisible} onClose={closeCreateHandler}>
          <Modal.Body>
            <Text h2 css={{ fontWeight: "500", fontFamily: "Ubuntu", fontSize: "28px", marginBottom: "-2px" }}>
              Studio {Studio.name}
            </Text>
          ...
          <Grid.Container style={{ flexDirection: "column" }}>
            <Modal.Body style={{ width: "100%", justifyContent: "space-between", flexDirection: "row" }}>
              <Modal.Body style={{ width: "100%" }}>
                <Input
                  ...
                  color="default"
                  bordered
                  placeholder="Portrait of Hiba in beach, looking to camera..."
              ...
              <Modal.Body style={{ width: "30%" }}>
                <Button
                  ...
                  iconRight={GeneratingImage ? <Loading color="currentColor" size="sm" /> : <GenerateIcon width={20} height={20} />}
                  color="success"
                  auto
                  style={{ fontFamily: "Ubuntu", fontSize: "20px" }}
            ...
            <Grid.Container style={{ textAlign: "left", marginLeft: "50px", marginTop: "-18px", width: "91%" }}>
              <Grid>
                <Text h3 style={{ fontFamily: "Ubuntu", fontSize: "17px", fontWeight: "400", color: "#3a3a3a" }}>
                  Use the keyword <strong>{Studio.name}</strong> as the subject in your prompt. First prompt can be slow, but following prompts will
                  be faster
                </Text>
              </Grid>
              <Grid style={{ width: "96%" }}></Grid>
              <Grid.Container style={{ justifyContent: "center", paddingBottom: "30px", width: "96%" }}>
                {GeneratedImages.length === 0 && !GeneratingImage && (
                  <Grid style={{ width: "100%" }}>
                    <Divider y={3} />
                    <Text style={{ fontFamily: "Ubuntu", fontSize: "18px", fontWeight: "400", color: "#3a3a3a", textAlign: "center" }}>
                      You dont't have any prompt yet. it's time to be create!
                    </Text>
                  </Grid>
                )}
                {GeneratingImage && (
                    ...
                    <Grid.Container key={index}>
                      ...
                      <Grid style={{ display: "flex", flex: "1", alignItems: "center" }}>
                        ...
                        <Grid style={{ marginLeft: "13px" }}>
                          <Text style={{ fontFamily: "Ubuntu", fontSize: "18px", fontWeight: "500", color: "#3a3a3a" }}>
                            {GeneratedPrompts[index].slice(0, 60) + (GeneratedPrompts[index].length > 60 ? "..." : "")}
                          </Text>
        ...
        <Grid.Container style={{ flexWrap: "wrap" }} gap={1}>
          {Data.map((image, index) => (
            <div key={index} className={styles.image_cover}>
              <Grid css={{ borderRadius: "15px" }} onClick={() => openHandler(image)}>
                <img
                  src={image}
                  alt="image"
                  style={{
          ...
          <Modal width="650px" open={visible} onClose={closeHandler}>
            <Modal.Body style={{ padding: "30px 20px 30px 20px" }}>
              ...
              <Modal.Body style={{ justifyContent: "space-between", flexDirection: "row" }}>
                <Text h3 style={{ fontFamily: "Ubuntu", fontSize: "23px" }}>
                  AI Generated Image
                </Text>
                <Button
                  ...
                  auto
                  onPress={() => {
                    handleDeleteImg(selectedImageSrc);
                  }}
                  style={{ fontFamily: "Ubuntu", fontSize: "20px" }}
                >
                  Delete
              ...
              <Modal.Body style={{ justifyContent: "center", alignItems: "center" }}>
                <Modal.Body>
                  <Button
                    icon={<DownloadIcon width={26} height={26} />}
                    rounded
                    color="primary"
                    auto
                    style={{ fontFamily: "Ubuntu", fontSize: "22px", height: "50px" }}
                    onPress={() => {
                      downloadLowerResolutionImage(selectedImageSrc);
                    }}
                  >
                    Download 512x512
                  </Button>
