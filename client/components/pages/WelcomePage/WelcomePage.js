    ...
    <div className={styles.root}>
      <Container className={styles.ai_header}>
        <Grid.Container className={styles.ai_header_content}>
          <Grid>
            <h1 style={{ fontSize: "80px", color: "#000", fontFamily: "Ubuntu", fontWeight: 500, lineHeight: "90px", width: "90%" }}>
          ...
          <Grid className={styles.landing_details}>
            <Grid className={styles.lading_guide}>
              ...
              <p style={{ fontSize: "20px", width: "200px" }}>
                Upload <strong> some selfies </strong> of you (or other person) with different angles
              </p>
            </Grid>
            <Grid className={styles.lading_guide}>
              ...
              <p style={{ fontSize: "20px", width: "200px" }}>
                Take a coffee while we build <strong> your studio </strong> based on your photos
              </p>
            </Grid>
            <Grid className={styles.lading_guide}>
              ...
              <p style={{ fontSize: "20px", width: "200px" }}>
                Use your imagination to craft the <strong> perfect prompt! </strong>{" "}
              </p>
            </Grid>
          </Grid>
        </Container>
            ...
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  ...
                  <strong> 10-12 minutes</strong> to generate a studio.
                </Text>
              </Card>
            </div>
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  ...
                  <strong>trained model to generate amazing images </strong> using stable diffusion algorithm.
                </Text>
              </Card>
            </div>
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  <strong> Yes, you can </strong> use it commercially. You can use it for your business, your website, your social media, your blog or
                  sell as you like.
                </Text>
              </Card>
            </div>
          ...
          <div className={styles.fqa_content_2}>
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  <strong> No, you don't need any GPU </strong> to use Stable Diffusion or DreamBooth everything works in background to make it easy
            ...
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  DreamBooth is a tool to <strong> fine-tune </strong> an existing text-to-image model like Stable Diffusion using only a few of your
            ...
            <div className={styles.fqa_content_item}>
              <Card css={{ p: "$6", mw: "400px", paddingLeft: "$10", paddingRight: "$10", paddingTop: "$13", paddingBottom: "$15" }}>
                ...
                <Text>
                  ...
                  <strong> generating detailed images from text descriptions. </strong> It can also be used for tasks such as inpainting, outpainting,
